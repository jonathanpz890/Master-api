...
// 1. Trips
Plan.discriminator('Trip', new mongoose.Schema({
    data: {
        destination: String,
        startDate: String,
        endDate: String,
...
// 2. Events
Plan.discriminator('Event', new mongoose.Schema({
    data: {
        venue: {
            name: String,
            address: String,
...
// 3. Budgets
Plan.discriminator('Budget', new mongoose.Schema({
    data: {
        totalBudget: Number,
...
// 4. Life Plan
Plan.discriminator('Life Plan', new mongoose.Schema({
    data: {
        vision: String,
        area: { type: String, enum: ['Health', 'Career', 'Finance', 'Relationships', 'Personal Growth', 'Spirituality'] },
        milestones: [{
            title: String,
            date: String,
